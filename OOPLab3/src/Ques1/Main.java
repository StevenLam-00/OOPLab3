...
public class Main extends Canvas {
	...
	public static void main(String[] args) {
		...
		System.out.println("input the dimetion of lenght to draw 1 line");
		length=sc.nextInt();
		System.out.println("input the dimention of width to draw  rectangle1 and oval 1");
		width= sc.nextInt();
		System.out.println("input the dimention of height to draw  rectangle 1 and oval 1");
		height= sc.nextInt();
		
		System.out.println("input the dimention of width to draw  rectangle2 and oval 2");
		width2= sc.nextInt();
		System.out.println("input the dimention of height to draw  rectangle 2 and oval 2");
		height2= sc.nextInt();
	...
	public void paint(Graphics g) {
		...
		System.out.println("Area of oval 2"+oval.GetArea());
